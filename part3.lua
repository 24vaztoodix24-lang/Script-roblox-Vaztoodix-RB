-- PARTIE 3/4 - Fonctionnalités avancées (Exunys Aimbot V3 + Noclip + ESP)
...
local function LoadAimbot()
    ...
    if ok and module then
        ...
        -- Configuration : mur, équipe, FOV, mode de verrouillage
        pcall(function()
...
VAZ.LoadAimbot = LoadAimbot

-- ============================================================
-- NOCLIP (client-side robuste)
-- ============================================================
...
-- ============================================================
-- INVISIBLE / GODMODE / AUTOCLICK / ANTIAFK / CLONE / PARTICULES
-- ============================================================
...
print("✅ Partie 3/4 chargée - Aimbot Exunys V3 + Noclip + ESP amélioré")